...
<div class="spacer" style="margin-top:50px;"></div>
    <footer class="container-fluid" style="text-align:center;">
        <div class="col-md-6 col-md-offset-3">
            <img src="<? bloginfo('stylesheet_directory'); ?>/img/logo-2.svg" alt="nff logo">
            <ul class="list-inline">
                <? wp_list_pages('exclude=56&title_li='); ?>
            </ul>
            <div class="copyright text-muted small"><br>NORD FAMILY FOUNDATION <?php echo date('Y'); ?>. <br>  All Rights Reserved</div>
        </div>
    </footer>
